/**
 * Wii U Plaza Mii Data Checksum Fixer by GaryOderNichts
 * This is just <https://github.com/GaryOderNichts/wiiu-miidata-checksum-fixer>
 * adjusted to work with the 96 byte structures from the plaza save
 */
...
int main(int argc, char** argv)
{
    if (argc != 2)
    {
        printf("Wii U plaza Mii Data Checksum Fixer by GaryOderNichts\nUsage:\n    fixer <path to file>\n");
        return 0;
    }
